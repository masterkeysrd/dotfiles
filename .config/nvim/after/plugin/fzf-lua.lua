...
-- is loaded.
--- @plugin/diagnostic.lua disable-next-line: duplicate-set-field
...
add {
    {
        ...
        opts = function()
            ...
            return {
                ...
                grep = {
                    -- Search in hidden files by default if ripgrep is installed.
                    hidden = vim.fn.executable('rg') == 1,
        ...
        on_setup = function()
            ...
            vim.keymap.set('n', '<leader>pb', '<cmd>FzfLua buffers<cr>', { desc = 'Buffers' })
            ...
            vim.keymap.set('n', '<C-g>', '<cmd>FzfLua files<cr>', { desc = 'Find files' })
            vim.keymap.set('n', '<leader>fg', '<cmd>FzfLua live_grep<cr>', { desc = 'Grep' })
            vim.keymap.set('n', '<leader>ps', '<cmd>FzfLua live_grep<cr>', { desc = 'Search files' })
